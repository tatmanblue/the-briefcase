...
internal class SearchFilesTool
{
    ...
    public SearchFilesTool(FileRegistry registry, AppSettings appSettings, SearchCache searchCache)
    {
    ...
    [Description(
        ...
        "Returns file IDs, names, sizes, last modified timestamps, and where the match was found. " +
